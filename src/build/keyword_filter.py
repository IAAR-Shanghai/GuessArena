...
if __name__ == "__main__":
    ...
    filtered_keywords, _ = filter_by_sim(topic=topic, keywords=keywords)
    # best_k = find_best_k(filtered_keywords, max_clusters=10)
    # selected_keywords = cluster_keywords_with_graph(filtered_keywords, n_clusters=best_k)
    # print(selected_keywords)
    recall_chain = recall_chain_keywords(
        starting_kw="e-learning", keywords=filtered_keywords, max_depth=3
    )
    print(recall_chain)
